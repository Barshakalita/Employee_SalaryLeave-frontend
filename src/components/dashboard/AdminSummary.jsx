...
const AdminSummary =()=>{
    ...
    useEffect(()=>{
        const fetchSummary=async()=>{
            try{
                const summary=await axios.get('https://employee-salary-leave-api-bazz.vercel.app/api/dashboard/summary',{
                    headers:{
        ...
        <div className='p-6'>
           ...
           <div className="mt-12">
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-6 mt-6'>
                ...
                <SummaryCard icon={<FaCheckCircle />} text="Leave Approaved" number={summary.leaveSummary.approved} color="bg-green-600"/>
